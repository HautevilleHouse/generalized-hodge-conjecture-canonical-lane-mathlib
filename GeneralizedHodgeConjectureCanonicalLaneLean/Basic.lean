/-!
# generalized-hodge-conjecture-canonical-lane Lean migration boundary
...
`GeneralizedHodgeConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "generalized-hodge-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/generalized-hodge-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the generalized Hodge conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["algebraic-cycles", "algebraic-geometry", "cohomology", "hodge-theory", "mathematical-proof", "reproducibility", "generalized-hodge-conjecture", "canonical-lane", "local-to-global", "manifold-constrained"]
